...
import com.kia.muslimmediaapp.databinding.ActivityDetailBinding
import com.kia.muslimmediaapp.model.network.ArticlesItem
import com.squareup.picasso.Picasso

class DetailActivity : AppCompatActivity() {

    private var _binding: ActivityDetailBinding? = null //to check if the _binding is non null variable
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.apply {
            setDisplayHomeAsUpEnabled(true) //tombol balik ke activity sebelumnnya
