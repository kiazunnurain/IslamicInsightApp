...
import com.kia.muslimmediaapp.databinding.ItemNewsOneBinding
import com.kia.muslimmediaapp.model.network.ArticlesItem
import com.kia.muslimmediaapp.ui.DetailActivity
...
class NewsAdapter: RecyclerView.Adapter<NewsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        val dateArray = date?.split("-")?.toTypedArray() //delimiters = membagi string jadi array, to convert
        ...
        dateArray?.let {
            ...
            calendar.set(Calendar.MONTH, it[1]. toInt() -1) //-1 buat ngedefault monthnya januari, karena januari dihitungnya 0, kalo 1 dia bakal ke hitung 1
